...
/* ── Signature dishes — 6 hero-level images ── */
const SHOWCASE = [
  {
    img: 'https://images.pexels.com/photos/29306505/pexels-photo-29306505.jpeg?auto=compress&cs=tinysrgb&w=1200',
  ...
  {
    img: 'https://images.pexels.com/photos/18330008/pexels-photo-18330008.jpeg?auto=compress&cs=tinysrgb&w=1200',
  ...
  {
    img: 'https://images.pexels.com/photos/29285458/pexels-photo-29285458.jpeg?auto=compress&cs=tinysrgb&w=1200',
  ...
  {
    img: 'https://images.pexels.com/photos/29173105/pexels-photo-29173105.jpeg?auto=compress&cs=tinysrgb&w=1200',
  ...
  {
    img: 'https://images.pexels.com/photos/18177341/pexels-photo-18177341.jpeg?auto=compress&cs=tinysrgb&w=1200',
  ...
  {
    img: 'https://images.pexels.com/photos/28445587/pexels-photo-28445587.jpeg?auto=compress&cs=tinysrgb&w=1200',
            ...
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <div className="absolute top-5 left-5">
                  <span className="px-3 py-1.5 text-[11px] font-bold uppercase tracking-wider text-white rounded-lg backdrop-blur-md shadow-lg"
                    style={{ background: 'linear-gradient(135deg, rgba(232,117,10,0.9), rgba(201,60,32,0.9))' }}>
                    {item.tag}
                  </span>
                </div>
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6 sm:p-8">
                  <motion.h3
                    className="font-heading font-black text-2xl sm:text-3xl lg:text-4xl text-white leading-tight drop-shadow-lg"
                  ...
                  <motion.p
                    className="mt-2 text-sm sm:text-base text-white/60 max-w-md leading-relaxed"
                  ...
                  >
                    <span className="font-heading font-extrabold text-2xl text-flame-light drop-shadow-md">{item.price}</span>
                    <a
                      href={LINKS.swiggy}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="px-5 py-2 rounded-xl text-sm font-bold text-white transition-all duration-300 hover:scale-105 active:scale-95"
            ...
            {SHOWCASE.map((dish, i) => (
              ...
              >
                <div className="relative aspect-[4/3] lg:aspect-[16/9]">
                  ...
                  {i === active && (
                    <motion.div
                      className="absolute top-2 right-2 w-2 h-2 rounded-full bg-flame shadow-glow-flame"

      ...
      <div className="container-max section-padding relative z-10">
        ...
        >
          <motion.a
            ...
            className="inline-flex items-center gap-3 px-8 py-3.5 rounded-xl font-heading font-bold text-sm border-2 border-cream/15 text-cream/70 hover:border-flame hover:text-flame transition-all duration-300"
